    ...
    <section class="flex justify-center m-8">
      <div class="w-full max-w-4xl p-4 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <Form action={action}>
          ...
          <div class="relative z-0 w-full mb-6 group">
            <select
              id="course"
              name="course"
              class="block py-2.5 px-0 w-full text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            >
        ...
        {action.value?.success && (
          <p class="text-lg text-green-700 mt-4">
